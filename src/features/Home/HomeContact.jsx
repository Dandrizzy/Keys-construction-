...
const HomeContact = () => {
 ...
 return (
  <div className=" py-4 px-8 sm:w-[75%] lg:w-1/2 mx-auto">
   ...
   <Form id="message" className="flex flex-col gap-4 "
    ...
    <textarea {...register('message',)} required placeholder="Message" min={8} className="w-full sm:mx-auto sm:my-0 sm:w-[75%] focus:outline-none  border-b-2 border-b-yellow-500" />
    ...
    <Button className="border-2 w-[100%] sm:w-[100%] py-10 md:w-[50%] lg:w-[50%] xl:w-auto mx-auto my-0 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:hover:bg-slate-400 disabled:hover:outline-none disabled:border-none disabled:hover:border-none" disabled={isSending}>{isSending ? <SpinnerMini /> : 'SEND MESSAGE'}</Button>
   </Form>
  </div>
 );
};
